...
> 本文档为 AI 辅助开发提供项目上下文。最后更新: 2026-02-28 / v4.12.0
...
- **数据特征**: 单数据库，32 张核心表，支持 SN 码追溯、加权成本核算、应收应付管理、期末凭证生成
...
│       │   ├── AccountingView.vue   # 324 行 — 会计（凭证/科目/期间/账簿/应收/应付 6个Tab）
...
│       │   ├── accounting.js   # 账套/科目/期间/凭证/账簿/应收(14)/应付(11) 共30+函数
