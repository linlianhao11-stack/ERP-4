...
> 本文档为 AI 辅助开发提供项目上下文。最后更新: 2026-03-14 / v4.23.0
...
- **数据特征**: 单数据库，44 张核心表，支持 SN 码追溯、加权成本核算、应收应付管理、期末结转、三张财务报表
...
│       │   │   │   ├── ShoppingCart.vue       # 254 行 — 购物车列表（含 SearchableSelect 客户搜索）
