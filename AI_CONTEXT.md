...
> 本文档为 AI 辅助开发提供项目上下文。最后更新: 2026-03-15 / v4.25.0
...
- **数据特征**: 单数据库，46 张核心表，支持 SN 码追溯、加权成本核算、应收应付管理（含退货退款闭环、多单合并推送发票、勾单生成凭证）、多账套隔离、6 维辅助核算（客户/供应商/员工/部门/商品/银行）、期末结转、三张财务报表
