        ...
        <table class="w-full text-sm">
          ...
          <tbody class="divide-y">
            ...
            <tr v-for="b in items" :key="b.id" class="hover:bg-elevated">
              ...
              <td class="px-2 py-2 font-mono text-[12px]"><span class="max-w-48 truncate inline-block align-bottom" :title="b.original_receipt_no">{{ b.original_receipt_no || '-' }}</span></td>
              <td class="px-2 py-2 max-w-[120px] truncate">{{ b.reason || '-' }}</td>
