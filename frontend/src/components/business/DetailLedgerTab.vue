        ...
        <table class="w-full text-sm">
          <thead class="bg-elevated">
            <tr>
              ...
              <th v-if="data.aux_customer" class="px-2 py-2 w-28">客户</th>
              <th v-if="data.aux_supplier" class="px-2 py-2 w-28">供应商</th>
          ...
          <tbody class="divide-y">
            <tr class="bg-canvas">
              ...
              <td v-if="data.aux_customer" class="px-2 py-2"></td>
              <td v-if="data.aux_supplier" class="px-2 py-2"></td>
              <td class="px-2 py-2"></td><td class="px-2 py-2"></td>
            ...
            <tr v-for="(e, idx) in data.entries" :key="idx" class="hover:bg-elevated">
              ...
              <td v-if="data.aux_customer" class="px-2 py-2">{{ e.customer_name || '' }}</td>
              <td v-if="data.aux_supplier" class="px-2 py-2">{{ e.supplier_name || '' }}</td>
