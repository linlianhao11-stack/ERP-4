      ...
      <table class="w-full text-[13px]">
        ...
        <tbody>
          ...
          <tr v-for="b in items" :key="b.id">
            ...
            <td class="text-right">{{ fmtMoney(b.paid_amount) }}</td>
            <td class="text-right">{{ fmtMoney(b.unpaid_amount) }}</td>
            ...
            <td class="font-mono text-[12px] max-w-48 truncate" :title="b.purchase_order_no">{{ b.purchase_order_no || '-' }}</td>
            <td @click.stop>
