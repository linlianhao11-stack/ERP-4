...
class ReceiptRefundBill(models.Model):
    ...
    original_receipt = fields.ForeignKeyField("models.ReceiptBill", null=True, on_delete=fields.SET_NULL, related_name="refund_bills")
...
class DisbursementRefundBill(models.Model):
    ...
    original_disbursement = fields.ForeignKeyField("models.DisbursementBill", null=True, on_delete=fields.SET_NULL, related_name="refund_bills")
